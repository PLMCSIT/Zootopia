...
Public Class SyntaxTokenizer
    ...
    Private Sub CreatePatterns()
        ...
        pattern = New TokenPattern(CInt(SyntaxConstants.NULL), "NULL", TokenPattern.PatternType.STRING, "null")
        AddPattern(pattern)
        ...
        pattern = New TokenPattern(CInt(SyntaxConstants.ODA), "ODA", TokenPattern.PatternType.STRING, "<<")
        AddPattern(pattern)

        pattern = New TokenPattern(CInt(SyntaxConstants.CDA), "CDA", TokenPattern.PatternType.STRING, ">>")
        AddPattern(pattern)
